...
<div class="container">
    ...
    <h4 class="mb-3">Add Project Note ({{ $project->name }})</h4>
    
    <form method="POST" action="{{ route('projects.notes.store', $project->id) }}">
        @csrf
        ...
        <div class="mb-3">
            ...
            <!----hidden field--->
            <div class="mb-3 d-none" id="employee-select">
            ...
            {{-- Client visibility checkbox: hidden by default --}}
            <div class="row">
            <div class="col-md-6 mb-2 d-none" id="client-visible">
            ...
            <div class="col-md-6 mb-2 d-none" id="password-visible">
                <div class="form-check">
