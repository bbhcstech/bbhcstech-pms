        ...
        <div class="col-lg-8 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">Edit Business Address</h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.settings.business-address.update', $businessAddress) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="btn-group">
                                ...
                                @if($businessAddress->is_default && $addresses->count() > 1)
                                    <span class="btn btn-success disabled">
                                        <i class="bi bi-star-fill"></i> Current Default
                                    </span>
                                @endif
                            </div>
                        </div>
